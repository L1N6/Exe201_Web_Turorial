...
namespace EXE201_Tutor_Web_API.Services.OnCourseDetailService
{
    public class OnCourseDetailService : BaseService<OnCourseraDetail, OnCourseraDetailDto, int>
    {
        ...
        public OnCourseDetailService(IRepository<OnCourseraDetail, int> onCourseDetailRepository, IMapper mapper, OnCourseraDetailRepository repository) : base(onCourseDetailRepository, mapper)
        {
